...
$query = "select p.proj_id, p.name, p.pdesc, u.userfname, p.coder, p.tester, p.date from project_t as p join user_t as u on p.creator = u.user_id where proj_id = \"$proj_id\"";
