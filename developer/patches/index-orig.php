					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
							<form action="#" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									<select name="select" id="select" class="form-control w-75" required>

									</select>
								</div>
								<div class="form-group">
									<input type="file" name="fileinput" class="form-control w-75" required/>
								</div>
								<div class="form-group">
									<input type="submit" value="Submit File" class="btn btn-primary w-75 p-3"/>
								</div>
							</form>
					</div>
				</div>
