...
if($_POST){
    ...
    if(move_uploaded_file($_FILES['fileinput']['tmp_name'], $target)) {
        ...
        $kwery = "insert into source ( dir, proj_id ) values ( \"". $target ."\", ". $_POST[ "prjsel" ] ." )";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <form action="" method="post">
                <h1 class="display-5 text-light mt-3">Upload Base File</h1>
                <div class="input-group input-group-md mb-3">  
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-sm">Select Project</span>
                        </div>
                            <select class="form-control" name="prjsel" id="prjsel" required>
                            </select>
                </div>
                <div class="input-group input-group-md mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="input-group pt-2">
                    <input class="btn btn-success btn-block" type="submit" value="Upload File">
                </div>
                </form>
            </div>
        </div>
